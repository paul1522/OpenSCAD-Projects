...
d2 = bottom thickness
*/
module open_box(x1, y1, z1, r1, d1, d2) {
	rounded_rectangle(x1, y1, d2, r1);
...
d4 = bottom thickness
*/
module box_bottom(x1, y1, z1, r1, d1, z2, d2, d4) {
	x2 = d1/2+d2/2;
	y2 = d1/2+d2/2;
	x3 = x1-2*x2;
	y3 = y1-2*y2;
	...
	difference() {
		union() {
			open_box(x1, y1, z1-z2, r1, d1, d4);
			translate([x2, y2, 0]) {
				rounded_ring(x3, y3, z1-d2, r3, d3, d4);
			}
		}
		*for (ii = [1 : mm]) {
			xx1 = 5*ii;
...
d4 = top thickness
*/
module box_top(x1, y1, z1, r1, d1, z2, d2, d4) {
	x2 = d1/2+d2;
	y2 = d1/2+d2;
	x3 = x1-2*x2;
	y3 = y1-2*y2;
	...
	difference() {
		union() {
			open_box(x1, y1, z1-z2, r1, d1, d4);
			rounded_ring(x1, y1, z1-d2, r1, d3, d4);
		}
