...
function outer_z()         = inner_z()+2*wall_thickness();
...
module _stand_offs() {
	translate([twall_thickness(), twall_thickness(), wall_thickness()]) {
		stand_offs();
	}
}
...
module right_face() {
	translate([outer_x(), twall_thickness(), wall_thickness()+triser_z()])
		rotate([-90, 0, 0])
			rotate([0, -90, 0])
				mirror([0, 1, 0])
					children();
...
module left_face() {
	translate([0, outer_y()-twall_thickness(), wall_thickness()+triser_z()])
		rotate([0, 0, -90])
			rotate([-90, 0, 0])
				mirror([0, 1, 0])
					children();
...
module front_face() {
	translate([twall_thickness(), 0, wall_thickness()+triser_z()])
		mirror([0, 0, 1])
			rotate([-90, 0, 0])
				children();
}
...
module back_face() {
	translate([outer_x()-twall_thickness(), outer_y(), wall_thickness()+triser_z()])
		mirror([0, 1, 0])
			rotate([90, 0, 180])
				children();
}
